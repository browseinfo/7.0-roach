...
class sale_order(osv.osv):
    ...
    def _amount_all_total(self, cr, uid, ids, field_name, arg, context=None):
        ...
        for order in self.browse(cr, uid, ids, context=context):
            ...
            for line in order.order_line:
                ...
                val += self._amount_line_tax(cr, uid, line, order, context=context)
            if disc_method =='fix':
                new_amt = disc_amt
            if disc_method =='per':
    ...
    def _amount_line_tax(self, cr, uid, line,order, context=None):
        print "\n\nlinenenene",line,order
        val = 0.0
    ...
    def button_dummy(self, cr, uid, ids, context=None):
        sale_browse = self.browse(cr, uid, ids[0])
